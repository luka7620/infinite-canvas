...
export function CanvasProjectCard({ project }: { project: CanvasProject }) {
    ...
    return (
        <article className="group flex min-h-44 cursor-pointer flex-col justify-between rounded-lg border border-border bg-card p-5 transition hover:border-primary/40 hover:bg-secondary" onClick={() => !editing && open()}>
            ...
            <div className="mt-8 flex items-end justify-between gap-3">
                ...
                <div className="flex items-center gap-1" onClick={(event) => event.stopPropagation()}>
                    {editing ? (
                        ...
                        <>
                            <Button type="text" size="small" shape="circle" icon={<Download className="size-4" />} onClick={() => void exportCanvasProjects([project], project.title || "LukaLeng公益站")} aria-label="导出" />
